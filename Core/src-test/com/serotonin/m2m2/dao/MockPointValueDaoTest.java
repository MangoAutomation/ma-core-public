 ...
 */
public class MockPointValueDaoTest extends MangoTestBase {
    ...
    protected MockMangoLifecycle getLifecycle() {
        ...
        lifecycle.addRuntimeContextConfiguration(MockPointValueDaoSpringConfig.class);
        return lifecycle;
    }

    private static class MockPointValueDaoSpringConfig {
        @Bean
