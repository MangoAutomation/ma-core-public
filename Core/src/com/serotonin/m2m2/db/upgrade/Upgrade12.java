...
public class Upgrade12 extends DBUpgrade {
    ...
    public void upgrade() throws Exception {
	    ...
	    String[] derbyScript = {
	    	...
	    	"CREATE TABLE eventDetectors (id int NOT NULL generated by default as identity (start with 1, increment by 1),xid varchar(50) NOT NULL,typeName varchar(32) NOT NULL,sourceId int NOT NULL,data clob NOT NULL);",
