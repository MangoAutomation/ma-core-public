        ...
        public Object getValue(Object obj) throws CSVException{
            ...
            try {
                ...
                try {
                    ...
                    throw new CSVException(getter.getName() + " " + e1.getMessage());
                } catch (IllegalArgumentException e2) {
                    throw new CSVException(getter.getName() + " " + e2.getMessage());
                } catch (InvocationTargetException e3) {
                    throw new CSVException(getter.getName() + " " + e3.getMessage());
                }
            } catch (IllegalArgumentException e) {
                throw new CSVException(getter.getName() + " " + e.getMessage());
            } catch (InvocationTargetException e) {
                throw new CSVException(getter.getName() + " " + e.getTargetException().getMessage());
            }
        }
