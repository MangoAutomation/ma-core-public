 ...
 *
 */
public class AnalogTextRendererModelDefinition extends ModelDefinition{
	...
	public AbstractRestModel<?> createModel() {
		return new AnalogTextRendererModel();
	}
	...
	public boolean supportsClass(Class<?> clazz) {
		return AnalogTextRendererModel.class.equals(clazz);
	}
