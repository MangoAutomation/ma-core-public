 ...
 *
 */
public class BackupFailureEventTypeDefinition extends SystemEventTypeDefinition {

    @Override
    public String getTypeName() {
       return SystemEventType.TYPE_BACKUP_FAILURE;
    }

    @Override
    public String getDescriptionKey() {
        return "event.system.backupFailure";
    }
