 ...
 *
 */
public class EmailSendFailureEventTypeDefinition extends SystemEventTypeDefinition {

    @Override
    public String getTypeName() {
       return SystemEventType.TYPE_EMAIL_SEND_FAILURE;
    }

    @Override
    public String getDescriptionKey() {
        return "event.system.email";
    }
