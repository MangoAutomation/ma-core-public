 ...
 *
 */
public class UpgradeCheckEventTypeDefinition extends SystemEventTypeDefinition {

    @Override
    public String getTypeName() {
       return SystemEventType.TYPE_UPGRADE_CHECK;
    }

    @Override
    public String getDescriptionKey() {
        return "event.system.upgradeCheck";
    }
