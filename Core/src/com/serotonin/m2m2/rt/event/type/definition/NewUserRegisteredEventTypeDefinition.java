 ...
 *
 */
public class NewUserRegisteredEventTypeDefinition extends SystemEventTypeDefinition {

    @Override
    public String getTypeName() {
        return SystemEventType.TYPE_NEW_USER_REGISTERED;
    }

    @Override
    public String getDescriptionKey() {
        return "event.system.newUserRegistered";
    }
