...
public class ColorUtils {
    ...
    public static String toHexString(Color color) {
        ...
        sb.append("#");
        sb.append(org.apache.commons.lang3.StringUtils.leftPad(Integer.toHexString(color.getRed()), 2, '0'));
        sb.append(org.apache.commons.lang3.StringUtils.leftPad(Integer.toHexString(color.getGreen()), 2, '0'));
        sb.append(org.apache.commons.lang3.StringUtils.leftPad(Integer.toHexString(color.getBlue()), 2, '0'));
        return sb.toString();
    }
    ...
    private static Color hexToColor(String s) throws InvalidArgumentException {
        String rrggbb;
        if (s.length() == 4)
            rrggbb = s.substring(1, 2) + s.substring(1, 2) + s.substring(2, 3) + s.substring(2, 3) + s.substring(3, 4)
                    + s.substring(3, 4);
        else if (s.length() == 7)
