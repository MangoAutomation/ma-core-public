...
public class DataSourceTableDefinition extends AbstractTableDefinition {
    ...
    public static final Field<Integer> READ_PERMISSION_ALIAS = DSL.field( DSL.name("ds").append("readPermissionId"), SQLDataType.INTEGER.nullable(false));
    public static final Field<Integer> EDIT_PERMISSION_ALIAS = DSL.field( DSL.name("ds").append("editPermissionId"), SQLDataType.INTEGER.nullable(false));
