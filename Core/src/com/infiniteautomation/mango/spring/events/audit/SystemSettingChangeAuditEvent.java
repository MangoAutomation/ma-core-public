...
public class SystemSettingChangeAuditEvent extends AuditEvent {

    private final String key;
    private final String fromValue;
    private final String toValue;

    public SystemSettingChangeAuditEvent(PermissionHolder holder, String key, String fromValue, String toValue) {
