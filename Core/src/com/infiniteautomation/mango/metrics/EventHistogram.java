 ...
 * @author Terry Packer
 */
package com.infiniteautomation.mango.metrics;
...
/**
 * This class was lifted from the sero-utils library for use here, to avoid a dependency with said lib.
 * 
...
public class EventHistogram {
    ...
    public String toString() {
        return Arrays.toString(getEventCounts());
    }
