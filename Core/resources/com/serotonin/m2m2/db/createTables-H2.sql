...
ALTER TABLE "eventHandlersMapping"
    ADD CONSTRAINT "handlerMappingUniqueness" UNIQUE ("eventHandlerId", "eventTypeName", "eventSubtypeName",
                                                      "eventTypeRef1",
                                                      "eventTypeRef2");
...
-- [jooq ignore start]
-- Insert admin user
INSERT INTO "users" ("id", "name", "username", "password", "email", "phone", "disabled", "lastLogin", "homeUrl",
                     "receiveAlarmEmails",
